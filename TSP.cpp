...
void anneal ()//anneal func to put vector of points in order to make distance the smallest
{
    ...
    double stopTemp = 0.00000000000000000000001;//set the stop temperature - it determines the number of iterations the program goes through
...
{
    //give instructions
    cout << "Create a text file, with the first line contain the number of points" << endl;
    cout << "that need to be travelled then, on the next line," << endl;
    cout << "put the x (first) and y (second) coordinates of the first point" << endl;
    cout << "separated by a space, do that for every line such that" << endl;
    cout << "each line contains one points" << endl;
    ifstream infile;
